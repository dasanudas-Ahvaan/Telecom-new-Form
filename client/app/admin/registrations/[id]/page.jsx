        ...
        <div className="max-w-4xl mx-auto bg-white bg-opacity-95 p-6 sm:p-8 rounded-lg shadow-lg mt-8 text-gray-900">
            ...
            <div className="space-y-3">
                ...
                {/* --- UPDATED to use fullName --- */}
                 <p><strong>Full Name:</strong> {registration.fullName || <span className="text-gray-500 italic">N/A</span>}</p>
                         ...
                         <p key={index}>
                             ...
                             <span className="ml-2">
                                 {Array.isArray(field.value)
                                     ? field.value.join(', ')
                                     : (field.value !== null && field.value !== undefined ? String(field.value) : <span className="text-gray-500 italic">N/A</span>)
                                 }
                             </span>
                         </p>
                     ))
